...
Understand the core competencies and value propositions of the service, including the types of technical infrastructure supporting the services. For example, what key mechanisms does the service rely on? Does the service use any smart contracts? What functionality is possible with the wallet (ie. Transfers, dApp connections, Spending Limits, etc) and is the wallet compatible with Mobile, Browser, Desktop, or more? 

 

User experiences and integration paths:

To understand what the different options we have for integrating, and the different user experiences that come alongside each integration paths. Consider such as the ease of use, security, and functionality / capability with each path. 

 

Integration Effort:

To provide (1) an overview of the integration process and workflow for the different paths, (2) estimated and general timelines (by headcount in engineering days) to do a full integration, (3) an overview of supported platforms, protocols, asset types, assets, and other partnerships and integrations to provide supplementary services (4) and the level of developer support available throughout the initial integration process and operational maintenance. 

 

Security:

To understand the (1) security measures that are in place to protect users' assets and information. We can learn about the encryption standards, authentication methods, and other security features that are implemented in the API to prevent hacking and fraud. (2) To obtain an overview of the third security audits that have been conducted on the service. 
